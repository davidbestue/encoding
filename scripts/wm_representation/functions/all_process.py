...
for Subject in Subjects:
    for Brain_region in brain_regions:
        ...
        for idx_c, Condition in enumerate(Conditions):
            ...
            shuffled_rec = shuffled_reconstruction(signal_paralel, testing_angles, 25, WM, WM_t, Inter=Inter, region=Brain_region, condition=Condition, subject=Subject)
            Reconstructions_shuff.append(shuffled_rec)
