...
path_save_signal ='/home/david/Desktop/Reconstructions/IEM/IEM_train_dist_isol_test_target_close.xlsx' #cross_b001_target_mix_octave_1_7_far.xlsx'
path_save_shuffle = '/home/david/Desktop/Reconstructions/IEM/shuff_IEM_train_dist_isol_test_target_close.xlsx'
...
for Subject in Subjects:
    for Brain_region in brain_regions:
        ...
        if decoding_thing=='Distractor':
            training_thing = training_behaviour['dist_alone']
        ...
        for idx_c, Condition in enumerate(Conditions):
            Reconstruction, shuff = all_process_condition_shuff_close( Subject=Subject, Brain_Region=Brain_region, WM=WM, WM_t=WM_t, 
