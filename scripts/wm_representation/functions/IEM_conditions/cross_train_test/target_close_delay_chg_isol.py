...
path_save_signal ='/home/david/Desktop/Reconstructions/IEM/IEM_target_close_delay_chg_isol.xlsx' #cross_b001_target_mix_octave_1_7_far.xlsx'
path_save_shuffle = '/home/david/Desktop/Reconstructions/IEM/shuff_IEM_target_close_delay_chg_isol.xlsx'
...
Conditions=['1_7', '2_7'] # '1_0.2', '1_7', '2_0.2', '2_7'
...
for Subject in Subjects:
    for Brain_region in brain_regions:
        ...
        training_activity, training_behaviour = preprocess_wm_files(wm_fmri_paths, masks, wm_beh_paths, condition=cond_t_changed, 
        ...
        #
        if decoding_thing=='Distractor':
            training_thing_ch = training_behaviour['T']
        elif decoding_thing=='Target':
            training_thing_ch = training_behaviour['Dist']


        ##### Train your weigths
        WM, Inter = Weights_matrix_LM( delay_TR_cond, training_thing_ch )
        WM_t = WM.transpose()
