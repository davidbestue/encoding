...
path_save_signal ='/home/david/Desktop/Reconstructions/IEM/IEM_target_trtarg_isol_02_stimp.xlsx' #cross_b001_target_mix_octave_1_7_far.xlsx'
path_save_shuffle = '/home/david/Desktop/Reconstructions/IEM/shuff_IEM_target_trtarg_isol_02_stimp.xlsx'


## options (chek the filename too!)
decoding_thing = 'Target' #'Distractor' #'Target'
Distance_to_use = 'mix' #'close' 'far'
training_time= 'stim_p' #'stim_p'  'delay' 'respo'
