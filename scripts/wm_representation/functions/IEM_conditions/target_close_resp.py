...
path_save_signal ='/home/david/Desktop/Reconstructions/IEM/IEM_target_close_resp_100.xlsx' #cross_b001_target_mix_octave_1_7_far.xlsx'
path_save_shuffle = '/home/david/Desktop/Reconstructions/IEM/shuff_IEM_target_close_resp_100.xlsx'


## options (chek the filename too!)
decoding_thing = 'Target' #'Distractor' #'Target'
Distance_to_use = 'close'  #'close' 'far'
training_time= 'respo' #'stim_p'  'delay' 'respo'
