...
ax = sns.heatmap(Reconstruction, yticklabels=list(Reconstruction.index), cmap="viridis") #, vmin=-0.4, vmax = 0.6) # cmap= viridis "jet",  "coolwarm" RdBu_r, gnuplot, YlOrRd, CMRmap  , center = midpoint
