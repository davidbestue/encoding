...
path_save_signal ='/home/david/Desktop/Reconstructions/SVM/cross_b001_pfc_target_mix_quadrant.xlsx'
...
brain_regions = ['pfc']# 'frontinf'] #, 'visual', 'ips', 'pfc', ips', 'frontsup', 'frontmid', 'frontinf'
