...
def IEM_cross_condition_kfold_allTRs(testing_activity, testing_behaviour, decode_item, WM, WM_t, Inter, 
    tr_st, tr_end, n_slpits=10):
    ####
    ####
    #### IEM usando data de WM test
...
def IEM_cross_condition_kfold_shuff_allTRs(testing_activity, testing_behaviour, decode_item, WM, WM_t, Inter, condition, subject, region,
    iterations, tr_st, tr_end, ref_angle=180, n_slpits=10):
    ####
    ####
    #### IEM usando data de WM test
