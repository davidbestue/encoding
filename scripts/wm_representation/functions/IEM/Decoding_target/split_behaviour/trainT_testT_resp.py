...
path_save_signal ='/home/david/Desktop/Reconstructions/IEM/IEM_trainT_testT_resp.xlsx' 
path_save_reconstructions = '/home/david/Desktop/Reconstructions/IEM/IEM_heatmap_trainT_testT_resp.xlsx'

path_save_shuffle = '/home/david/Desktop/Reconstructions/IEM/shuff_IEM_trainT_testT_resp.xlsx'
    ...
    for Brain_region in brain_regions:
        for idx_c, Condition in enumerate(Conditions):
            ...
            if Condition == cond_t:  ### Cross-validate if training and testing condition are the same (1_7 when training on target and 2_7 when training on distractor)
                ...
                Reconstruction = IEM_cv_all_runsout_responded(testing_activity=activity, testing_behaviour=behaviour,
                ...
                shuff = IEM_cv_all_runsout_responded_shuff( testing_activity=activity, testing_behaviour=behaviour, 
                    decode_item=decoding_thing, training_item=training_item, tr_st=tr_st, tr_end=tr_end,
