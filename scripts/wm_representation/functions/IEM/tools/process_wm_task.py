...
def process_wm_task(wm_fmri_paths, masks, wm_beh_paths, sys_use='unix', nscans_wm=16, TR=2.335):
    #
    ...
    activity_beh  = Parallel(n_jobs = numcores)(delayed(process_behavior_file)(masked_data, beh_path, n_scans, sys_use='unix', TR=TR, nscans_wm=nscans_wm) for masked_data, beh_path, n_scans in zip( wm_masked, wm_beh_paths, scans_wm_runs))    ####
