...
path_save_behaviour ='/home/david/Desktop/Reconstructions/IEM/trainT_testT_behaviour_permissive.xlsx' 
path_save_reconst ='/home/david/Desktop/Reconstructions/IEM/recs_IEM_trainT_testT_wm3_permissive.npy' 
...
for Subject in Subjects:
    for Brain_region in brain_regions:
        ...
        for trial in range(len(behaviour)):
            ...
            #
            Weights_matrix, Interc = Weights_matrix_LM_3items_remove_permissive(activity_train_model_TRs, training_angles)
...
for i in range(len(Behaviour_)):
    Behaviour_[i].to_excel(writer, sheet_name=str(i)) #each dataframe in a excel sheet
