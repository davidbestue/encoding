...
for Subject in Subjects:
    for Brain_region in brain_regions:
        ...
        ###
        if cond_t == '1_7':
                boolean_trials_training = np.array(behaviour['delay1']==7)  *  np.array(behaviour['order']==1) 
        ###
        ...
        #
        Weights_matrixl3, Intercl3 = Weights_matrix_LM_3items(activity_train_model_TRs, training_angles)
        matrix_weights_L3.append(Weights_matrixl3)
        #
        ...
        matrix_weights_.append(Weights_matrix)
