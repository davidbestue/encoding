...
path_save_behaviour ='/home/david/Desktop/Reconstructions/IEM/IEM_trainT_testT_trials_pos_delays.xlsx' 
    ...
    for Brain_region in brain_regions:
        ...
        for trial in range(len(behaviour)):
            ...
            for Delay_ in ['Delay_1', 'Delay_2', 'Delay_end']:
                ...
                Inverted_encoding_model_pos = Pos_IEM(Inverted_encoding_model)
