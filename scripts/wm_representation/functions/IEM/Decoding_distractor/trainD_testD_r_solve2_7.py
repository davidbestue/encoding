...
path_save_signal ='/home/david/Desktop/Reconstructions/IEM/IEM_trainD_testD_runs_solve2_7.xlsx' 
path_save_reconstructions = '/home/david/Desktop/Reconstructions/IEM/IEM_heatmap_trainD_testD_runs_solve2_7.xlsx'

path_save_shuffle = '/home/david/Desktop/Reconstructions/IEM/shuff_IEM_trainD_testD_runs_solve2_7.xlsx'
    ...
    for Brain_region in brain_regions:
        for idx_c, Condition in enumerate(Conditions):
            ...
            if Condition == cond_t:  ### Cross-validate if training and testing condition are the same (1_7 when training on target and 2_7 when training on distractor)
                ############# I am actually not doing cross-validation: I am leaving a session out and doing the mean, but not a random resampling
                #############
