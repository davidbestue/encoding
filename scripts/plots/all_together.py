...
for i_c, CONDITION in enumerate(['1_0.2', '1_7', '2_0.2', '2_7']): #
    ...
    df_all_by_subj['condition'] = CONDITION
    df_condition.append( df_all_by_subj )
...
df_condition =pd.concat(df_condition)

sns.pointplot(ax=ax, x='timepoint', y='Decoding', hue='condition', data=df_condition, size=5, pallete ='tab10', aspect=1.5)
plt.tight_layout()
