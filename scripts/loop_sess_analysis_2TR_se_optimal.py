...
def enc_model_analysis( Subj, areas, cond_use):
    for SUBJECT_USE_ANALYSIS in Subj:  #, 'd001', 'r001', 'b001', 'l001', 's001'
        print(SUBJECT_USE_ANALYSIS)
        for brain_region in areas:   # , "ips"
            ...
            for session_enc in range(0,len(func_encoding_sess)):
                ...
                ##
                for CONDITION in cond_use: #, '1_7', '2_0.2', '2_7'
                    ...
                    for trial in range(0, len(beh_Subset)):
                        ...
                        for time_scan in range(0, nscans_wm, 2 ):
                            ...
                            angle_trial =  beh_Subset['Dist'].iloc[trial] #3 14
...
Subjects = ['n001']
areas_to_use=["visual"]
#cond_to_use = ['1_0.2', '1_7', '2_0.2', '2_7']
cond_to_use = ['1_0.2']
